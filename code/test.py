...
class VideoDataset(Dataset):
    ...
    def __init__(self, dataset='DMD-lite-70', split='test', clip_len=70, preprocess=False, transform=None):
    ...
    def preprocess(self):
        ...
        for file in os.listdir(self.root_dir):
            test = os.path.join(self.root_dir, file)
...
if __name__ == "__main__":
    ...
    train_data = VideoDataset(dataset='DMD-lite-70', split='test', clip_len=70, preprocess=True)
